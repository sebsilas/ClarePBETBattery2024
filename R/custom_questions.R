  ...
  psychTestR::join(
    ...
    psychTestR::conditional(
      ...
      logic = psychTestR::checkbox_page(
        label = "musician_type",
        prompt = shiny::tags$div(shiny::tags$h2("Question 1/11"),
    ...
    psychTestR::conditional(
      ...
      logic = psychTestR::join(
        ...
        psychTestR::NAFC_page(
          label = "practice_type",
          prompt = shiny::tags$div(shiny::tags$h2("Question 2/11"),
    ...
    psychTestR::NAFC_page(
      label = "primary_genre",
      prompt = shiny::tags$div(shiny::tags$h2("Question 3/11"),
    ...
    psychTestR::NAFC_page(
      ...
      prompt = shiny::tags$div(shiny::tags$h2("Question 4/11"),
                               shiny::tags$p("I listen to the pieces that I am learning for approx:")),
      choices = c(
    ...
    psychTestR::NAFC_page(
      ...
      prompt = shiny::tags$div(shiny::tags$h2("Question 5/11"),
    ...
    psychTestR::NAFC_page(
      ...
      prompt = shiny::tags$div(shiny::tags$h2("Question 6/11"),
    ...
    psychTestR::NAFC_page(
      ...
      prompt = shiny::tags$div(shiny::tags$h2("Question 7/11"),
    ...
    psychTestR::checkbox_page(
      label = "note_reading",
      prompt = shiny::tags$div(shiny::tags$h2("Question 8/11"),
    ...
    psychTestR::NAFC_page(
      ...
      prompt = shiny::tags$div(shiny::tags$h2("Question 9/11"),
    ...
    psychTestR::dropdown_page(
      label = "highest_grade",
      prompt = shiny::tags$div(shiny::tags$h2("Question 10/11"),
    ...
    # psychTestR::dropdown_page(
    #   label = "suzuki_book",
    #   prompt = shiny::tags$div(shiny::tags$h2("Question 11/11"),
